...
一个 CLI 工具，用于导入 LeetCode 题目并生成 Obsidian 兼容的 Markdown 知识库。支持中文标题/标签（通过 leetcode.cn API）、Hot 100 标记、学习笔记模板和自动生成索引。

## 功能

- 通过题目编号、URL 或 slug 导入 LeetCode 题目
- 中文标题、标签和题目描述（leetcode.cn API）
- 自动标记 Hot 100 题目
- 章节学习笔记模板（如二叉树、动态规划）
- 自动生成索引（按难度、分类、Hot 100）
- Obsidian 双向链接，构建知识图谱
